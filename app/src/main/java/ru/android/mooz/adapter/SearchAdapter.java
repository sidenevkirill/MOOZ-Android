...
import ru.android.mooz.activity.PlayListActivity;
import ru.android.mooz.model.SearchPlaylist;

public class SearchAdapter extends RecyclerView.Adapter<PlayListAdapter.CustomViewHolder> {
    ...
    public PlayListAdapter.CustomViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LinearLayout v = (LinearLayout) LayoutInflater.from(parent.getContext()).inflate(R.layout.item_search, parent, false);
