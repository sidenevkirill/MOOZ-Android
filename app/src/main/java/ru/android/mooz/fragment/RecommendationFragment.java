...
public class RecommendationFragment extends Fragment implements SongAdapter.ItemClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private void createAdapter(List<Song> songs) {
        adapter = new SongAdapter(getActivity(), songs, RecommendationFragment.this);
