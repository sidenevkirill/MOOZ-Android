...
public class NewFragment extends Fragment implements SongAdapter.ItemClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private void createAdapter(List<Song> songs) {
        adapter = new SongAdapter(getActivity(), songs, NewFragment.this);
