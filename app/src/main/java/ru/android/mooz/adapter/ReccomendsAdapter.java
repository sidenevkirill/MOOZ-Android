...
public class ReccomendsAdapter extends RecyclerView.Adapter<PlayListAdapter.CustomViewHolder> {
    ...
    public ReccomendsAdapter() {
        data = new ArrayList<>();
    }

    @Override
    public PlayListAdapter.CustomViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LinearLayout v = (LinearLayout) LayoutInflater.from(parent.getContext()).inflate(R.layout.item_rec, parent, false);
