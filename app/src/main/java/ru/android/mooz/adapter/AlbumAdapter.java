...
public class AlbumAdapter extends RecyclerView.Adapter<PlayListAdapter.CustomViewHolder> {
    ...
    public PlayListAdapter.CustomViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LinearLayout v = (LinearLayout) LayoutInflater.from(parent.getContext()).inflate(R.layout.item_album, parent, false);
